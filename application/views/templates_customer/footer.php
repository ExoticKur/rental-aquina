                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                <img src="<?php echo base_url() ?>assets/assets_shop/img/aquina.png" height="800" width="200" alt="JSOFT">
                                <p>AQuina Ratu Jambi adalah penyedia jasa rental terpercaya berdiri sejak tahun 2012 dengan harga yang murah dengan kualitas mobil bintang lima.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i> AQuina Ratu Jambi Jalan Kabia RT 003 No. 69 Kelurahan Handil Jaya, Kec.amatan Jelutung, Kota Jambi, Jambi</li>
                                    <li><i class="fa fa-mobile"></i> +62 852 6693 0933</li>
                                    <li><i class="fa fa-envelope"></i> welly.well87@gmail.com</li>
                                </ul>
                                <a href="https://goo.gl/maps/vV8hJYteYiBakKDV6" class="map-show" target="_blank">Lihat Lokasi</a>
                            </div>
                        </div>
                    </div>
                    <!-- Single Footer Widget End -->
