...
<head>
    ...
    <!--=== Favicon ===-->
    <link rel="icon" href="assets/assets_shop/img/logo1.png"/>

    <title>AQUINA RATU JAMBI</title>
    ...
    <div class="preloader">
        <div class="preloader-spinner">
            <div class="loader-content">
                <img src="<?php echo base_url() ?>assets/assets_shop/img/honda.gif" alt="" width="100%">
            </div>
        </div>
    </div>
    <!--== Preloader Area End ==-->
