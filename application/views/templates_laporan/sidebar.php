      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="<?php echo (strpos(current_url(), "admin/laporan") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/laporan') ?>"><i class="fas fa-clipboard-list"></i> <span>Laporan Transaksi</span></a></li>

              <li class="<?php echo (strpos(current_url(), "admin/laporan/mobil") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/laporan/mobil') ?>"><i class="fas fa-clipboard-list"></i> <span>Laporan Mobil</span></a></li>
              
              <li class="<?php echo (strpos(current_url(), "admin/laporan/customer") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/laporan/customer') ?>"><i class="fas fa-clipboard-list"></i> <span>Laporan Customer</span></a></li>
