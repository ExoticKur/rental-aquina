	...
	<div class="row">
					...
					<table class="table">
						<?php foreach($transaksi as $tr) : ?>
							...
							<tr class="text-danger">
								<th>Denda Keterlambatan Pengembalian/Hari </th>
								<td>: </td>
								<td><button class="btn btn-sm btn-danger" disabled="disabled">Rp. <?php echo number_format(($tr->denda),0,',','.') ?></button></td>
							</tr>
							<!--  -->
		...
		<div class="col-md-4">
			<div class="card" style="margin-top: 110px">
				...
				<div class="card-body">
					<p class="text-success mb-3"> Silakan Melakukan Pembayaran Melalui Rekening Bank di Bawah Ini: </p>

					<ul class="list-group list-group-flush" id="rekening">
							<p><b><img src="<?php echo base_url() ?>assets/assets_shop/img/bca.png" height="90" width="90" alt="JSOFT"> 8190092403 (A.n Welly)</p>
							<p><img src="<?php echo base_url() ?>assets/assets_shop/img/mandiri.png" height="90" width="90" alt="JSOFT"> 12345 (A.n Welly)</p>
							<p><img src="<?php echo base_url() ?>assets/assets_shop/img/bni.png" height="80" width="80" alt="JSOFT"> 12345 (A.n Welly)</p>
							<p><img src="<?php echo base_url() ?>assets/assets_shop/img/bri.png" height="70" width="70" alt="JSOFT"> 12345 (A.n Welly)</p>
